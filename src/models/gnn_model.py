"""
Graph Attention Network for Alzheimer's disease prediction.

Implements a GAT-based model with dual output heads:
- Graph-level head: Binary classification (AD vs Control)
- Node-level head: Per-protein importance scores

Includes training orchestration, evaluation, and explainability.
"""
